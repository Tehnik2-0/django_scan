...
from djangoProject.settings import IMAGE_ROOT


# from db import add_scan
# import shutil
...
#     directory = "C:/Users/SystemPoint/PycharmProjects/OCR/Распознано"
#     for file in files:
#         if '.' in file:
#             result = start(path + '/' + file)
#             end_path = path[68:]
#             add_scan(path=directory + '/' + end_path + '/' + file, text=result)
#             shutil.copy(path + '/' + file, directory + '/' + end_path + '/' + file)
#         else:
#             if not os.path.exists(directory + '/' + file):
#                 os.mkdir(directory + '/' + file)
#             directory_in_path(path + '/' + file)
#
#
# directory = "C:/Users/user/Desktop/djangoProject/Паспорта для распознования"
# files = os.listdir(directory)
# directory_in_path(directory)